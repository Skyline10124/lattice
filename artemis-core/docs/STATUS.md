...
- CLI: artemis run "prompt" + artemis -p "prompt"
- TUI: cargo run -p artemis-tui
...
- artemis-tui has warnings (cosmetic)
- Some catalog providers untested

## Crates (12)
artemis-core, artemis-agent, artemis-memory, artemis-token-pool,
artemis-plugin, artemis-python, artemis-harness, artemis-cli, artemis-tui
